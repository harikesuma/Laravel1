...
<div class="container">
        <div class="card card border-primary mb-3 mt-4">
                ...
                <div class="card-body text-primary">
                  <form action="/prodi/{{$prodiedit->id}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                       <label for="colFormLabel" class="col-sm-2 col-form-label">Program Studi</label>
                       <div class="col-sm-10">
                       <input type="text" name="prodi" class="form-control" id="colFormLabel" value="{{$prodiedit->prodi}}" placeholder="Harap diisi" required>
                       </div>
                      </div>
